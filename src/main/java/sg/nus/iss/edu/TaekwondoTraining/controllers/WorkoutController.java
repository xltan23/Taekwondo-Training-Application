...
public class WorkoutController {
    ...
    // Link to access user's Poomsae training page (localhost:8080/workout/{user})
    @GetMapping("{user}")
    public String getUserStandardWorkout(
    ...
    public String postStandardWorkout(@RequestBody MultiValueMap<String,String> form, Model model) {
    ...
    // Form info post to (localhost:8080/workout/clear)
